            ...
            <div class="tab-class text-center">
                <div class="row g-4">
                    <div class="col-lg-4 text-start">
                        <h1>Our High-Quality Products</h1>
                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <form action="{{ route('user#home') }}" method="get">
                                            ...
                                            <input type="submit" value="Search" class=" btn  my-2 w-100" style="color:#BFD1E5; background-color: #542344;">
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="col-9">
                                <div class="row g-4">
                                   ...
                                   @if (count($products) != 0)
                                        ...
                                        <div class="col-4">
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="text-white  px-3 py-1 rounded position-absolute"
                                                    style="top: 10px; left: 10px; background-color: #542344;">{{ $item->category_name }}</div>
                                                <div class="p-4 border  border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        ...
                                                        <a href="{{ route('user#productDetails', $item->id) }}"
                                                            class="btn border border-secondary rounded-pill px-3 mt-2 ">View More</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                    <h3 class="text-muted mt-5"><i class="fa-regular fa-circle-xmark"></i> No Items</h3>
                                   @endif
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    ...
                                                    <a href="#"
                                                        class="btn rounded-pill px-3 text-primary" ><i
