...
@section('content')
    <div class="container">
        <div class=" d-flex justify-content-between my-2">
            ...
            <span>User Count - {{ count($accounts) }}</span>
                    ...
                    <tbody>
                        ...
                        @foreach ($accounts as $item)
                            <tr>
                                ...
                                <td><span class="btn btn-sm bg-primary text-white rounded shadow-sm">
                                {{ $item->role }}</span></td>
                                ...
                                <td>
                                   <button type="button" onclick="deleteFunction({{ $item->id }})" class="btn btn-sm btn-danger text-white"><i class="fa-solid fa-trash-can text-white"></i></button>
                                </td>
                            </tr>
                        @endforeach
