...
<head>
    ...
    <link href="{{asset("admin_template/css/sb-admin-2.css")}}" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav  sidebar sidebar-dark accordion" style=" background-color: #542344;" id="accordionSidebar">
           ...
           @endif
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('change#passwordPage') }}"><i class="fa-solid fa-lock"></i></i></i><span>Change Password </span></a>
            </li>
            ...
            <li class="nav-item">
                <form action="{{ route("logout") }}" method="post">
                    @csrf
                    <span class="nav-link">
                        <button type="submit" class="btn bg-danger text-white rounded"><i
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset(auth()->user()->profile == null ? 'defaultImage/defaultProfile.jpg': 'adminProfile/'. auth()->user()->profile) }}">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                               ...
                               @if (auth()->user()->role == 'superadmin')
                                    ...
                                    <a class="dropdown-item" href="{{ route('profile#accountList',  ['accountType' => 'admin']) }}">
                                        <i class="fas fa-users fa-sm fa-fw mr-2 text-gray-400"></i>
                                        Admin List
                                    </a>

                                    <a class="dropdown-item" href="{{ route('profile#accountList',  ['accountType' => 'user']) }}">
                                        <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                                        User List
                                    </a>
                               @endif
                                ...
                                <a class="dropdown-item" href="{{ route('change#passwordPage') }}">
